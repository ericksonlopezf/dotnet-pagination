...
public class PaginationOperationTransformerTests
{
    ...
    private static OpenApiOperationTransformerContext CreateContext(string methodName)
    {
        ...
        return new OpenApiOperationTransformerContext
        {
            ...
            DocumentName = "v1",
            ApplicationServices = new Microsoft.Extensions.DependencyInjection.ServiceCollection().BuildServiceProvider()
        };
    }

    [Fact]
    public async Task TransformAsync_WithoutPaginationOrFilter_DoesNotModifyOperation()
    {
    ...
    [Fact]
    public async Task TransformAsync_WithPagination_AnnotatesExistingParameters()
    {
        var transformer = new PaginationOperationTransformer();
        var operation = new OpenApiOperation
        {
    ...
    [Fact]
    public async Task TransformAsync_WithCursorPagination_AnnotatesExistingParameters()
    {
        var transformer = new PaginationOperationTransformer();
        var operation = new OpenApiOperation
        {
    ...
    [Fact]
    public async Task TransformAsync_WithFilter_InjectsFilterParameterIfNotExists()
    {
        var transformer = new PaginationOperationTransformer();
    ...
    [Fact]
    public async Task TransformAsync_WithFilter_AnnotatesExistingFilterParameter()
    {
        var transformer = new PaginationOperationTransformer();
        var operation = new OpenApiOperation
        {
    ...
    [Fact]
    public async Task TransformAsync_WithUnrelatedParameters_IgnoresThem()
    {
        var transformer = new PaginationOperationTransformer();
        var operation = new OpenApiOperation
        {
    ...
    public async Task TransformAsync_WithSortBy_InjectsSortByParameterIfNotExists(string methodName)
    {
        var transformer = new PaginationOperationTransformer();
        var operation = new OpenApiOperation();
    ...
    [Fact]
    public async Task TransformAsync_WithSortBy_DoesNotInjectIfAlreadyExists()
    {
        var transformer = new PaginationOperationTransformer();
        var operation = new OpenApiOperation
        {
    ...
    [Fact]
    public void AddPaginationSupport_RegistersTransformerAndExecutesIt()
    {
        var options = new Microsoft.AspNetCore.OpenApi.OpenApiOptions();
        
        Action act = () => options.AddPaginationSupport();
        
        act.Should().NotThrow();
    }

    [Fact]
    public async Task TransformAsync_WithExistingDescriptions_DoesNotOverwriteThem()
    {
        var transformer = new PaginationOperationTransformer();
        var operation = new OpenApiOperation
        {
    ...
    [Fact]
    public async Task TransformAsync_WithFilter_DoesNotInjectIfAlreadyExists()
    {
        var transformer = new PaginationOperationTransformer();
        var operation = new OpenApiOperation
        {
    ...
    public async Task TransformAsync_WithSort_AnnotatesExistingSortParameter(string methodName, string paramName)
    {
        var transformer = new PaginationOperationTransformer();
        var operation = new OpenApiOperation
        {
    ...
    [Fact]
    public async Task TransformAsync_WithPrimitiveTypes_DetectsParameters()
    {
        var transformer = new PaginationOperationTransformer();
        var operation = new OpenApiOperation
        {
    ...
    [Fact]
    public async Task TransformAsync_WithSortParameters_DetectsParameters()
    {
        var transformer = new PaginationOperationTransformer();
    ...
    [Fact]
    public async Task TransformAsync_WithAll_AnnotatesExistingParametersWithoutDescriptions()
    {
        var transformer = new PaginationOperationTransformer();
        var operation = new OpenApiOperation
        {
