...
(async () => {
  ...
  {
    const mockContext = {
      repo: { owner: 'ericksonlopezf', repo: 'dotnet-pagination' },
      sha: 'fresh1234567890'
    };
                  ...
                  statuses: [
                    {
                      ...
                      target_url: 'https://github.com/ericksonlopezf/dotnet-pagination/actions/runs/12345'
                    }
                  ]
                }
              };
              ...
              statuses: [
                {
                  ...
                  updated_at: oldDate,
                  target_url: 'https://github.com/ericksonlopezf/dotnet-pagination/actions/runs/999'
                }
              ]
            }
          })
              ...
              statuses: [
                {
                  ...
                  description: 'Score: 100.0% - ✅ HIGH',
                  updated_at: freshDate,
                  target_url: 'https://github.com/ericksonlopezf/dotnet-pagination/actions/runs/1000'
                }
              ]
            }
          }),
              ...
              statuses: [
                {
                  ...
                  updated_at: freshDate,
                  target_url: 'https://github.com/ericksonlopezf/dotnet-pagination/actions/runs/1001'
                }
              ]
            }
          })
