...
| [`EricksonLopez.Pagination.SqlBuilder`](https://www.nuget.org/packages/EricksonLopez.Pagination.SqlBuilder) | [![NuGet](https://img.shields.io/nuget/v/EricksonLopez.Pagination.SqlBuilder?style=flat-square)](https://www.nuget.org/packages/EricksonLopez.Pagination.SqlBuilder) | Standalone AST SQL query builder integration for offset and keyset pagination |
...
| `EricksonLopez.Pagination.SqlBuilder` | ✅ | ✅ | ✅ | ❌ | ✅ Fully AOT | ✅ |
