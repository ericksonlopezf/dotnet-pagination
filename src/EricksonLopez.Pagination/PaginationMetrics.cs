...
public static class PaginationMetrics
{
    ...
    private const string StrategyTag = "pagination.strategy";
    ...
    {
        QueriesTotal.Add(1, new KeyValuePair<string, object?>(StrategyTag, "offset"));
        PageSize.Record(pageSize, new KeyValuePair<string, object?>(StrategyTag, "offset"));
        PageDepth.Record(page, new KeyValuePair<string, object?>(StrategyTag, "offset"));
    }
    ...
    {
        QueriesTotal.Add(1, new KeyValuePair<string, object?>(StrategyTag, "keyset"));
        PageSize.Record(pageSize, new KeyValuePair<string, object?>(StrategyTag, "keyset"));
    }
    // Stryker restore all
}
