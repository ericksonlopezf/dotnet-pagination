...
| `EricksonLopez.Pagination.SqlBuilder` | Standalone SQL query builder integration for offset and keyset pagination | `net8.0;net9.0;net10.0` |
...
Abstractions (zero dependencies)
    └── Core (implements Abstractions)
            ...
            ├── SqlBuilder   (extends Core, uses EricksonLopez.SqlBuilder)
